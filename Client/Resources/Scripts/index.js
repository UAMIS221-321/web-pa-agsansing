...
function blankFields(){
    ...
    ocument.getElementById("bookAuthor").value="";
    ocument.getElementById("bookGenre").value="";
    ocument.getElementById("bookAvlb").value="";
    ocument.getElementById("bookIsbn").value="";
    ocument.getElementById("bookLength").value="";
    ocument.getElementById("bookCover").value="";
}
